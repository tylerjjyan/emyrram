    ...
    content: (
      <>
        ...
        <Paragraph
          variant="medium"
          marginBottom="24px"
          text={`You acknowledge and agree that we provide access to such tools ”as is”
        ...
        <Paragraph
          variant="medium"
          marginBottom="24px"
          text={`Any use by you of optional tools offered through the site is entirely at
    ...
    content: (
      <>
        ...
        <Paragraph
          variant="medium"
          marginBottom="24px"
          text={`You are solely responsible for any comments you make and their accuracy.
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Paragraph
          variant="medium"
          text={`In no case shall Club Kitchen Management Inc., our directors, officers, employees,
  ...
  },
  {
    ...
    content: (
      <>
        <Paragraph
          variant="medium"
          text={`You agree to indemnify, defend and hold harmless Club Kitchen Management Inc. and our
    ...
    content: (
      <>
        <Paragraph
          ...
          laws of 900-1095 West Pender St., Vancouver BC, V6E 2M6, Canada.`}
        />
      </>
    )
  },
